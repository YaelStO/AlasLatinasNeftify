<template>
  <div class="page conoce-tu-pais">
    <h1>Conoce a tu país</h1>
    <p>Rutas y destinos dentro de México para que redescubras tu país.</p>
...
onMounted(async () => {
  try {
    ...
    all.value = res.data
    const targets = ['Oaxaca', 'Huatulco', 'Campeche', 'Yucatán', 'Baja California', 'Oaxaca de Juárez', 'Chichén Itzá']
