<template>
  <div class="page visitas-raras">
    <h1>Visitas Raras</h1>
    <p>Destinos poco comunes y exóticos para viajeros curiosos.</p>
...
onMounted(async () => {
  try {
    ...
    all.value = res.data
    // Filtrar por países poco comunes indicados
    const targets = ['North Korea', 'Pyongyang', 'Romania', 'Iran', 'Uzbekistan', 'Samarkand']
